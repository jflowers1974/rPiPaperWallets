...
cd /home/pi/wxwidgets/wxWidgets-master/include              # go to wx include folder
...
wx_top_builddir="/home/pi/veracrypt/src/wxrelease"
top_srcdir="/home/pi/wxwidgets/wxWidgets-master"
flags="-D_FILE_OFFSET_BITS=64 -DwxDEBUG_LEVEL=0 -I${wx_top_builddir}/lib/wx/include/base-unicode-static-3.1 -I${top_srcdir}/include -DWX_PRECOMP -fdata-sections -ffunction-sections -pthread -fdata-sections -ffunction-sections -O2 "
...
flags="-I . -I /home/pi/wxwidgets/wxWidgets-master/include $flags -D__WXDEBUG__ -D__WX__ -DWXBUILDING $allheaders"
